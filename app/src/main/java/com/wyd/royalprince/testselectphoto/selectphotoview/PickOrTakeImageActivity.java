...
import com.wyd.royalprince.testselectphoto.MyApp;
import com.wyd.royalprince.testselectphoto.R;
import java.io.File;
 ...
 * 仿微信选取手机所有图片，或者拍照界面
 */
public class PickOrTakeImageActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener,
...
//        window.setBackgroundDrawable(getResources().getDrawable(R.color.white));
    ...
    protected void initData() {
        ...
        //计算每张图片应该显示的宽度
        perWidth = (((WindowManager) (MyApp.getInstance().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getWidth() - CommonUtil.dip2px(this, 4)) / 3;
